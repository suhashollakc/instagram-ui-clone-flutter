...
import 'appbar.dart';
 ...
 TextStyle textStyleLightGrey = new TextStyle(
   fontFamily: 'Gotham', color: Colors.grey
 );


 Post post1 = new Post(
   AssetImage('assets/photo_1.jpeg'),
   user,
   "My First Post",
   DateTime.now(),
 ...
 User follower1 = new User(
   'the rock', AssetImage('assets/follower3.jpeg'),[],[],[],[],true
 );
User follower2 = new User('miley_cyrus', AssetImage('assets/follower2.jpg'),
    [], [], [], [], false);
...
User follower6 = new User('peter_griffin',
    AssetImage('assets/profile4.png'), [], [], [], [], false);
